...
$steps = [
  ...
  ['03', 'Dérouler le temps', 'Le mois type est répété sur l’horizon choisi. Les livrets capitalisent à leur taux, saturent à leur plafond, et le surplus part vers la destination câblée.', ['Horizons prêts : 12, 60 et 120 mois.', 'Chaque livret affiche sa date de saturation.', 'La projection se recalcule à chaque modification.'], [['Épargné par mois','860 €'],['Patrimoine dans 5 ans','55 786 €'],['LEP A plein en','38 mois'],['Dépenses cumulées','325 200 €']]],
];
foreach ($steps as $s): ?>
