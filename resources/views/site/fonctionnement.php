...
<?php
$steps = [
  ['01', 'Poser les entrées', 'Un bloc par source d’argent. Vous indiquez un montant mensuel — net, brut provisionné, ou variable moyenné.', ['Un revenu peut alimenter plusieurs comptes.', 'Les revenus irréguliers se saisissent en moyenne lissée.', 'Les provisions (URSSAF, impôt) se posent comme des dépenses dédiées.'], [['Salaire','1 320 €'],['Auto-entreprise','1 800 €'],['Loyers du local','540 €'],['Total entrées','6 280 €']]],
  ['02', 'Câbler les flux', 'Vous tirez un fil du point de sortie d’un bloc vers le point d’entrée d’un autre, puis vous choisissez ce qui circule : un montant fixe, un pourcentage, ou tout le reste.', ['« Tout le reste » évite de recalculer à la main.', 'Un répartiteur signale si les parts ne font pas 100 %.', 'Chaque montant est écrit sur le tuyau.'], [['→ Joint Factures','2 280 €'],['→ Joint Quotidien','2 760 €'],['→ Répartiteur épargne','tout le reste'],['Non affecté','0 €']]],
  ['03', 'Dérouler le temps', 'Le mois type est répété sur l’horizon choisi. Les livrets capitalisent à leur taux, saturent à leur plafond, et le surplus part vers la destination câblée.', ['Horizons selon le plan : 24 mois, 60 mois ou 50 ans.', 'Chaque livret affiche sa date de saturation.', 'La projection se recalcule à chaque modification.'], [['Épargné par mois','860 €'],['Patrimoine dans 5 ans','55 786 €'],['LEP A plein en','38 mois'],['Dépenses cumulées','325 200 €']]],
];
foreach ($steps as $s): ?>
