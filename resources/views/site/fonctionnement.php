...
$steps = [
  ...
  ['03', 'Dérouler le temps', 'Le mois type est répété sur l’horizon choisi. Les livrets capitalisent à leur taux, saturent à leur plafond, et le surplus part vers la destination câblée.', ['Horizons prêts : 12, 60 et 120 mois.', 'Chaque livret affiche sa date de saturation.', 'La projection se recalcule à chaque modification.'], [['Épargné par mois','5 234 €'],['Patrimoine dans 5 ans','105 615 €'],['Livret A plein en','16 mois'],['Dépenses cumulées','426 240 €']]],
];
foreach ($steps as $s): ?>
